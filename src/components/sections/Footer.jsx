...
const Footer = () => {
    return (
        <div className="bg-[#06091A]">
            ...
            <div className="w-10/12 mx-auto p-4 border rounded-xl">
                <div className=" bg-white text-center items-center flex flex-col gap-2 border rounded-xl py-14 ">
            ...
            <div className='flex flex-col items-center text-white py-8'>
                ...
                <div className='w-10/12 mx-auto flex justify-between py-8'>
                    ...
                    <div>
                        ...
                        <input className="py-3 px-4  rounded-xl w-56 mr-4 text-xs" type="email" placeholder="Enter your email"/>
